export const NavbarLinks = () => {
  return (
    <div className="text-base items-start box-border caret-transparent gap-x-2.5 flex flex-col leading-4 gap-y-2.5 w-full md:text-xl md:items-center md:gap-x-[34px] md:flex-row md:leading-5 md:gap-y-[34px] md:w-auto">
      <a
        href="/about-us"
        className="text-white text-base box-border caret-transparent flex leading-[22.4px] min-h-0 min-w-0 w-full py-[5px] md:text-lg md:block md:leading-[25.2px] md:min-h-[auto] md:min-w-[auto] md:w-auto md:py-0 hover:text-white/60 hover:underline hover:border-white/60"
      >
        Studio
      </a>
      <a
